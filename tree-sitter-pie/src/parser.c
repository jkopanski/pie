...
static const char * const ts_symbol_names[] = {
  ...
  [aux_sym_claim_token1] = "claim_token1",
  [anon_sym_RPAREN] = ")",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym_claim_token1] = aux_sym_claim_token1,
...
static inline bool aux_sym_claim_token1_character_set_1(int32_t c) {
  return (c < 7773
    ? (c < 1153
      ? (c < 466
        ? (c < 328
...
static inline bool aux_sym_claim_token1_character_set_2(int32_t c) {
  return (c < 7773
    ? (c < 1151
      ? (c < 464
        ? (c < 326
...
static inline bool aux_sym_claim_token1_character_set_3(int32_t c) {
  return (c < 7168
    ? (c < 3168
      ? (c < 2417
        ? (c < 1519
...
static inline bool sym_type_character_set_1(int32_t c) {
  return (c < 8027
    ? (c < 910
      ? (c < 500
        ? (c < 452
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 8594) ADVANCE(24);
      if (aux_sym_claim_token1_character_set_1(lookahead)) ADVANCE(17);
      if (sym_type_character_set_1(lookahead)) ADVANCE(25);
      END_STATE();
    case 1:
      if (lookahead == '\t' ||
          lookahead == '\n' ||
      ...
      END_STATE();
    case 2:
      if (sym_atom_character_set_1(lookahead)) ADVANCE(20);
      END_STATE();
    case 3:
      if (eof) ADVANCE(4);
      if (lookahead == '\t' ||
      ...
      if (lookahead == ')') ADVANCE(18);
      if (lookahead == ';') ADVANCE(26);
      if (aux_sym_claim_token1_character_set_2(lookahead)) ADVANCE(17);
      if (sym_type_character_set_1(lookahead)) ADVANCE(25);
      END_STATE();
    case 4:
    ...
    case 6:
      ...
      if (sym_atom_character_set_1(lookahead)) ADVANCE(17);
      END_STATE();
    case 7:
      ACCEPT_TOKEN(aux_sym_claim_token1);
      if (lookahead == '>') ADVANCE(23);
      if (aux_sym_claim_token1_character_set_3(lookahead)) ADVANCE(17);
      END_STATE();
    case 8:
      ACCEPT_TOKEN(aux_sym_claim_token1);
    ...
    case 25:
      ...
      if (sym_atom_character_set_1(lookahead)) ADVANCE(25);
      END_STATE();
    case 26:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [aux_sym_claim_token1] = ACTIONS(1),
  ...
  [1] = {
    ...
    [aux_sym_claim_token1] = ACTIONS(9),
    [sym_atom] = ACTIONS(11),
    [sym_type] = ACTIONS(11),
    [sym_comment] = ACTIONS(3),
  },
  ...
  [5] = {
    ...
    [aux_sym_claim_token1] = ACTIONS(38),
    [sym_atom] = ACTIONS(41),
    [sym_type] = ACTIONS(41),
    [sym_comment] = ACTIONS(3),
  },
  [6] = {
    ...
    [aux_sym_claim_token1] = ACTIONS(47),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [38] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(17),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(5),
  [44] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2), SHIFT_REPEAT(4),
  [47] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2), SHIFT_REPEAT(17),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2),
  [52] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_repeat1, 2), SHIFT_REPEAT(6),
  ...
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_application, 4, .production_id = 1),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_type, 5, .production_id = 4),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function, 7, .production_id = 5),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_claim, 5, .production_id = 2),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_define, 5, .production_id = 3),
